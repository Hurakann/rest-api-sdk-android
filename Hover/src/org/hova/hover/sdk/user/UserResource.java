...
public class UserResource implements PostRequestExectue, getRequestExectue, PutRequestExectue {
	...
	public void sendPhoneVerification(String uri, String server, String body)
	 ...
	 *            An Action object
	 *            
	 * @deprecated use {@link #metricUser()} instead.
	 */
	@Deprecated
	 ...
	 *
	 */
	public void metricUser(Action action) throws ClientProtocolException, URISyntaxException, IOException {
		cPOSTAsync = new ClientPOSTAsync(this);
		Gson gs = new Gson();
		type = "metric";
	...
	public void updateUser(User user) throws ClientProtocolException,
