...
public class ClassReflect {
	 ...
	 * @param obj
	 *            the new instance of the class (object)
	 * @return A map object that stores {name,value}
	 * @throws IllegalAccessException
	 * @throws IllegalArgumentException
	 * @throws InvocationTargetException
	 */
	public Map<String, String> reflectFields(Class<?> clazz, Object obj)
		...
		System.arraycopy(fieldsThis, 0, fields, fieldsSuper.length,
				fieldsThis.length);
